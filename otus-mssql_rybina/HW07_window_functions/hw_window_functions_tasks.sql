...
1. время ЦП с оконной функцией в 8 раз меньше (с 3983мс до 516мс), затраченное время - уменьшилось в 3,5 раза (с 5876 мс до 1679 мс)
2. количество сканирований к таблицам InvoiceLines (с 22х до 2х) и Invoices (с 12 до 1) так же уменьшилось практически в 10 раз
*/
